...
internal static class ShadowResourceWriter
{
    ...
    private static BoxShadow GetKeyShadow(int y, int blur) => new() { OffsetX = 0, OffsetY = y, Blur = blur, Spread = 0 };
    private static BoxShadow GetAmbientShadow(int y, int blur, int spread) => new() { OffsetX = 0, OffsetY = y, Blur = blur, Spread = spread };

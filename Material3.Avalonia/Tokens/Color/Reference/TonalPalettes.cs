    ...
    TonalPalette error)
{
    ...
    public global::Avalonia.Media.Color Resolve(PaletteKind palette, int tone)
    ...
    public global::Avalonia.Media.Color this[PaletteKind palette, int tone] => Resolve(palette, tone);
    ...
    /// </summary>
    public IEnumerable<(string key, global::Avalonia.Media.Color color)> EnumerateRefColorEntries()
    {
        ...
        static IEnumerable<(string, global::Avalonia.Media.Color)> Dump(TonalPalette p)
        {
    ...
    public static TonalPalettes FromDictionaries(
        IDictionary<int, global::Avalonia.Media.Color> primary,
        IDictionary<int, global::Avalonia.Media.Color> secondary,
        IDictionary<int, global::Avalonia.Media.Color> tertiary,
        IDictionary<int, global::Avalonia.Media.Color> neutral,
        IDictionary<int, global::Avalonia.Media.Color> neutralVariant,
        IDictionary<int, global::Avalonia.Media.Color> error)
        => new(

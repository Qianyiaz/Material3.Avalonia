...
public static class FocusRing
{
    public static readonly AttachedProperty<CornerRadius> CornerRadiusProperty =
        AvaloniaProperty.RegisterAttached<Control, CornerRadius>("CornerRadius", typeof(FocusRing), new CornerRadius(0));
    ...
    public static readonly AttachedProperty<CornerRadius> EffectiveCornerRadiusProperty =
        AvaloniaProperty.RegisterAttached<Control, CornerRadius>("EffectiveCornerRadius", typeof(FocusRing), new CornerRadius(0));
    [EditorBrowsable(EditorBrowsableState.Never)]
    internal static void SetEffectiveCornerRadius(AvaloniaObject o, CornerRadius v) => o.SetValue(EffectiveCornerRadiusProperty, v);
    ...
    private static void Recalculate(Control c)
    {
        ...
        SetEffectiveMargin(c, new Thickness(-t.Left - d.Left, -t.Top - d.Top, -t.Right - d.Right, -t.Bottom - d.Bottom));

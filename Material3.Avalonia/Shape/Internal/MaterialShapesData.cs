...
internal static class MaterialShapesData
{
    ...
    private static RoundedPolygon? _cookie4;
    private static RoundedPolygon? _cookie6;
    private static RoundedPolygon? _cookie7;
    private static RoundedPolygon? _cookie9;
    private static RoundedPolygon? _cookie12;
    private static RoundedPolygon? _ghostish;
    private static RoundedPolygon? _clover4;
    private static RoundedPolygon? _clover8;
    ...
    public static RoundedPolygon Circle => _circle ??= CreateCircle().Normalized();
    public static RoundedPolygon Square => _square ??= CreateSquare().Normalized();
    public static RoundedPolygon Slanted => _slanted ??= CreateSlanted().Normalized();
    public static RoundedPolygon Arch => _arch ??= CreateArch().Normalized();
    public static RoundedPolygon Fan => _fan ??= CreateFan().Normalized();
    public static RoundedPolygon Arrow => _arrow ??= CreateArrow().Normalized();
    public static RoundedPolygon SemiCircle => _semiCircle ??= CreateSemiCircle().Normalized();
    public static RoundedPolygon Oval => _oval ??= CreateOval().Normalized();
    public static RoundedPolygon Pill => _pill ??= CreatePill().Normalized();
    public static RoundedPolygon Triangle => _triangle ??= CreateTriangle().Normalized();
    public static RoundedPolygon Diamond => _diamond ??= CreateDiamond().Normalized();
    public static RoundedPolygon ClamShell => _clamShell ??= CreateClamShell().Normalized();
    public static RoundedPolygon Pentagon => _pentagon ??= CreatePentagon().Normalized();
    public static RoundedPolygon Gem => _gem ??= CreateGem().Normalized();
    public static RoundedPolygon VerySunny => _verySunny ??= CreateVerySunny().Normalized();
    public static RoundedPolygon Sunny => _sunny ??= CreateSunny().Normalized();
    public static RoundedPolygon Cookie4 => _cookie4 ??= CreateCookie4().Normalized();
    public static RoundedPolygon Cookie6 => _cookie6 ??= CreateCookie6().Normalized();
    public static RoundedPolygon Cookie7 => _cookie7 ??= CreateCookie7().Normalized();
    public static RoundedPolygon Cookie9 => _cookie9 ??= CreateCookie9().Normalized();
    public static RoundedPolygon Cookie12 => _cookie12 ??= CreateCookie12().Normalized();
    public static RoundedPolygon Ghostish => _ghostish ??= CreateGhostish().Normalized();
    public static RoundedPolygon Clover4 => _clover4 ??= CreateClover4().Normalized();
    public static RoundedPolygon Clover8 => _clover8 ??= CreateClover8().Normalized();
    public static RoundedPolygon Burst => _burst ??= CreateBurst().Normalized();
    public static RoundedPolygon SoftBurst => _softBurst ??= CreateSoftBurst().Normalized();
    public static RoundedPolygon Boom => _boom ??= CreateBoom().Normalized();
    public static RoundedPolygon SoftBoom => _softBoom ??= CreateSoftBoom().Normalized();
    public static RoundedPolygon Flower => _flower ??= CreateFlower().Normalized();
    public static RoundedPolygon Puffy => _puffy ??= CreatePuffy().Normalized();
    public static RoundedPolygon PuffyDiamond => _puffyDiamond ??= CreatePuffyDiamond().Normalized();
    public static RoundedPolygon PixelCircle => _pixelCircle ??= CreatePixelCircle().Normalized();
    public static RoundedPolygon PixelTriangle => _pixelTriangle ??= CreatePixelTriangle().Normalized();
    public static RoundedPolygon Bun => _bun ??= CreateBun().Normalized();
    public static RoundedPolygon Heart => _heart ??= CreateHeart().Normalized();
    ...
    private static List<PointNRound> DoRepeat(List<PointNRound> src, int reps, Point center, bool mirroring)
    {
        ...
        else
        {
            ...
            var distances = src.Select(s => new Vector2((float)(s.P.X - center.X), (float)(s.P.Y - center.Y)).Length()).ToArray();
